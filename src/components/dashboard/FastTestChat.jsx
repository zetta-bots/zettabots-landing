          ...
          >
            ...
            <div style={{ 
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: '0.75rem', color: 'rgba(167, 139, 250, 0.8)', fontWeight: 600 }}>Cérebro: {getInstanceDisplayName(selectedInstance)}</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSendMessage} style={{ padding: '12px 16px', background: 'rgba(0,0,0,0.2)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              <p style={{ margin: '8px 0 0', fontSize: '0.65rem', color: 'rgba(255,255,255,0.3)', textAlign: 'center' }}>
                {getInstanceDisplayName(selectedInstance)} está usando a base de conhecimento atualizada ⚡
              </p>
          </form>
        </div>
      )}
