const IntegrationsPanel = ({ webhookUrl, setWebhookUrl, googleCalendarId, setGoogleCalendarId, handleSaveIntegrations }) => {
  return (
      ...
      <div className="glass-card" style={{ padding: '2.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'rgba(66, 133, 244, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.2rem' }}>📅</div>
              <h4 style={{ margin: 0, fontSize: '1rem', fontWeight: '700' }}>Google Calendar</h4>
            </div>
            <p style={{ margin: 0, fontSize: '0.8rem', color: '#64748b', lineHeight: '1.5' }}>
              Sincronize agendamentos da IA diretamente com a sua agenda pessoal.
            </p>
            <div style={{ marginTop: '5px' }}>
              <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.75rem', fontWeight: '700', color: '#94a3b8', letterSpacing: '0.05em' }}>
                ID DA AGENDA (E-MAIL)
