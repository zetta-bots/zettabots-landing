    ...
    <div className="tab-panel reveal-item" style={{ animationDelay: '0.1s' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '2rem' }}>
        ...
        <div className="glass-card" style={{ padding: '2.5rem', border: '1px solid rgba(124, 58, 237, 0.1)', position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', top: 0, right: 0, width: '150px', height: '150px', background: 'radial-gradient(circle, rgba(124, 58, 237, 0.1) 0%, transparent 70%)', zIndex: 0 }} />
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '3rem' }}>
              ...
              <div className="stat-info">
                ...
                <span style={{ fontSize: '1rem', fontWeight: '700', color: '#64748b', marginTop: '4px', display: 'block', opacity: 0.8 }}>#{session?.phone?.slice(-8)}</span>
              </div>
            </div>
